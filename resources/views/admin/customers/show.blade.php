                                    ...
                                    @if($user->user_id != Auth::user()->user_id)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $user->user_id }}" action="{{ route('customers.destroy',$user->user_id) }}" style="display: none;" method="post">
                                                    {{@csrf_field()}}
                                                    {{@method_field('DELETE')}}
                                                </form>
        ...
        <div class="modal-content">
             ...
             <div class="modal-body">
                  <div class="col-md-12">
                    <div class="card mb-4">
                         <div class="card-body">
                             <form role="form" method="post" action="{{ route('customers.update.appUser',$user->user_id) }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="app_user_id" id="app_user_id">
                                 <div class="row">
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="First name" id="fname" name="fname" value="{{ old('fname') }}">
                                        @error('firstname')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Surname" id="lname" name="lname" value="{{ old('lname') }}">
                                        @error('lname')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="tel" class="form-control" placeholder="Mobile Number" id="mobileno" name="mobileno" value="{{ old('mobileno') }}">
                                        @error('mobileno')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="customerno" name="customerno" placeholder="Customer Number" value="{{ old('customerno') }}">
                                        @error('customerno')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="password" class="form-control" placeholder="Pin" id="pin" name="pin" value="{{ old('pin') }}">
                                        @error('pin')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>

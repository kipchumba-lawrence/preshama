                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="eiend-in1" name="role" required="required" >
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mb-4" id="degree3" placeholder="First name" value="{{ old('firstname') }}" name="firstname" required="required">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="degree4">Last name</label>
                                                                        <input type="text" class="form-control mb-4" id="degree4" placeholder="Surname" value="{{ old('lastname') }}" name="lastname" required="required">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

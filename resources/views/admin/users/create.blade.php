                        ...
                        <form method="post" action="{{ route('users.store') }}">
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="First name"
                                           name="firstname" value="{{ old('firstname') }}" required="required">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Second name</label>
                                    <input type="text" class="form-control" id="inputPassword4"
                                           placeholder="Second name" name="secondname" value="{{ old('secondname') }}"
                                           required="required">
                                </div>
                            </div>
                            <div class="form-row mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" id="inputAddress2"
                                       placeholder="Temporary password" name="password" value="{{ old('password') }}"
                                       required="required">
                            </div>

...
@endsection
@section('page-action')
    <h3>Credit Manager - Approve orders ({{ $orders->count() }} total)</h3>
@endsection
            ...
            <div class="row layout-top-spacing">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <form action="{{ route('creditManagerApproval') }}" method="post">
                            {{csrf_field()}}
                            <button class="dt-button btn btn-primary btn-sm" tabindex="0" aria-controls="invoice-list" type="submit"><span>Approve</span></button>
                            ...
                            @foreach($orders as $order)
                                <tr>
                                   <td>
                                    ...
                                    <td>
                                      <small>{{ $order->customer->customer_no }} </small>
                                    </td>
                                    <td>

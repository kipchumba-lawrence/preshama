        ...
        <ul class="list-unstyled menu-categories ps" id="accordionExample">
            @if(Auth::user()->user_type=='Admin')
                ...
                <li class="menu">
                    ...
                    <ul class="submenu list-unstyled collapse" id="customers" data-parent="#accordionExample" style="">
                        <li>
                    ...
                    <ul class="submenu list-unstyled collapse" id="submenu" data-parent="#accordionExample" style="">
                        <li>
